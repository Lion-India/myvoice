...
import app.com.worldofwealth.BuildConfig;
import app.com.worldofwealth.agora.common.Constant;
import app.com.worldofwealth.agora.openlive.AGApplication;
import app.com.worldofwealth.agora.openlive.model.ConstantApp;
import app.com.worldofwealth.agora.openlive.model.EngineConfig;
import app.com.worldofwealth.agora.openlive.model.MyEngineEventHandler;
import app.com.worldofwealth.agora.openlive.model.WorkerThread;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    private boolean checkSelfPermissions() {
        return checkSelfPermission(Manifest.permission.RECORD_AUDIO, ConstantApp.PERMISSION_REQ_ID_RECORD_AUDIO) &&
                ...
                checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE, ConstantApp.PERMISSION_REQ_ID_READ_EXTERNAL_STORAGE);
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            ...
            case ConstantApp.PERMISSION_REQ_ID_READ_EXTERNAL_STORAGE: {
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                } else {
                    finish();
