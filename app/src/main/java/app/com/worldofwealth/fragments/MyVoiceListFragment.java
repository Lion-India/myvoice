...
public class MyVoiceListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new JudiciariesUserListAdapter(getActivity(), userlist, user,"Myvoice");
    ...
    private void GetUserList() {
        String url = CommonUtil.mbaseurl + "Users/GetUsers?usertype=Myvoice";
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    for (int i = 0; i < jarr.length(); i++) {
                        ...
                        if(user.getUsertype().equals("Myvoice")) {
                            userlist.add(user);
                        }
                    }
                    mAdapter = new JudiciariesUserListAdapter(getActivity(), userlist, user,"Myvoice");
