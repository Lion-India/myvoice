...
public class LawMakersListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new JudiciariesUserListAdapter(getActivity(), userlist, user,"Lawmakers");
    ...
    public void onResume() {
       ...
       private void GetUserList() {
        String url = CommonUtil.mbaseurl + "Users/GetUsers?usertype=Lawmakers";
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    for (int i = 0; i < jarr.length(); i++) {
                        ...
                        if(user.getUsertype().equals("Lawmakers")) {
                            userlist.add(user);
                        }
                    }
                    mAdapter = new JudiciariesUserListAdapter(getActivity(), userlist, user,"Lawmakers");
