...
public class JudiciaryListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new JudiciariesUserListAdapter(getActivity(), userlist, user, "Judiciaries");
    ...
    private void GetUserList() {
        String url = CommonUtil.mbaseurl + "Users/GetUsers?usertype=Judiciaries";
